...
Another common reason is for investors who are extremely risk averse. The lower risk associated with bonds can also be used in tandem with a well diversified stock portfolio in order to tune it to the individual's risk tolerance. The biggest question to ask yourself however is whether the potential to make less in the long run worth the potential safety that bonds may provide.

I feel these points only apply to higher credit rating bonds with lower risk though. Lower rating junk bonds may not fulfill this role well or at all. You also need to ask yourself if you feel the corporation or government you are purchasing the bond from is actually good for the money in your own personal opinion, not so simply trust the credit rating alone.
...
To start we first need to understand volatility. I will not use any math, I promise! Essentially for the average Joe, volatility can be summed up with “how quickly and how much will my asset go up and down in price”. Obviously this is HEAVILY simplified, but we are trying to avoid complexity here. Now that you have that in your head, when you compare BND and S&P 500 you can see that S&P 500 goes up and down a lot, while BND has not done much in quite some time. So clearly S&P 500 is vastly more volatile than BND.

This means the more BND (or the combination of bonds in the index BND is following) you add to your portfolio the less volatile the overall portfolio becomes. I would highly recommend reading “The Intelligent Investor", It goes into serious depth on portfolio allocations that you just cannot get from a blog post.

Overall if you are severely adverse to volatility and downside, then adding bonds to your portfolio might be a good idea. Assuming you are also ok with giving up the potential long-term and short-term upside in advance.
